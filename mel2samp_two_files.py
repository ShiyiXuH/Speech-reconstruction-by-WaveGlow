...
class Mel2SampTwoFiles( Mel2Samp ):
    def __init__(self, training_files, segment_length, filter_length,
                 hop_length, win_length, sampling_rate, mel_fmin, mel_fmax, dir_normal, dir_hi, target_factor = 1,n_mel_channels=80):
...
if __name__ == "__main__":
    ...
    mel2samp = Mel2SampTwoFiles(**data_config,n_mel_channels=waveglow_config['n_mel_channels'])
